...
namespace FinalProject
{
    public class MovieManager
    {
        ...
        public static void SearchMovie(string title)
        {
            ...
            var findMovies = movies.FindAll(m => m.MovieName.Equals(title));
        ...
        public static void RemoveMovie(string title)
        {
            ...
            var findMovies = movies.Find(m => m.MovieName.Equals(title));
        ...
        public static void EditMovie(string title)
        {
            ...
            var movieToEdit = movies.Find(m => m.MovieName.Equals(title));
